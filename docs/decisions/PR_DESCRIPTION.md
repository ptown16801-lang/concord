# Consolidate Concord decisions and add maintenance checks

Concord decisions were spread across local drafts, sessions, branch-specific specs,
Linear and stale handoffs. This change adds one root master designated for Develo,
