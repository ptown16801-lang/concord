...
- `docs/IDENTITY_PERSISTENCE_CONTRACT.md` defines Concord's design-only governance-identity, reconstruction, isolated-memory, succession, history/search, and lifecycle-view contract.
