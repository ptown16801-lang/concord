...
- `docs/GENERATIVE_AGENTS_ANALYSIS.md` records the source-verified JON-116 technical and emergence analysis, Concord mapping, experimental design, and evidence-routed development options.
